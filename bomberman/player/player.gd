...
func _physics_process(delta: float) -> void:
	...
	if is_death == false:
		...
		var x_input := int(Input.is_action_pressed("p1_right")) - int(Input.is_action_pressed("p1_left"))
		var z_input := int(Input.is_action_pressed("p1_down")) - int(Input.is_action_pressed("p1_up"))
